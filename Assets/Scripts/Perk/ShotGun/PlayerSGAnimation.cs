...
public class PlayerSGAnimation : PlayerAnimation
{
    ...
    public override void DashAnime()
    {
        ...
        TrackEntry entry = sk.AnimationState.AddAnimation(1, "step", false, 0);
        entry.MixDuration = 0.1f;
    ...
    {// 0 기본사격, 1 대각선, 2 위, 3 조준
        ...
        if (dir == 0)
        {
            if (!playerMove.sit)
            {
                ...
                //    entry.MixDuration = 0.1f;
                //    entry.AnimationStart = AttackTime;
                //}
                TrackEntry entry = sk.AnimationState.AddAnimation(3, "shoot", false, 0);
                entry.MixDuration = 0.1f;
                entry.AnimationStart = AttackTime;
        ...
        sk.AnimationState.AddEmptyAnimation(3, 0.1f, 0.9f); 
    }
    ...
    public override void ShootDone()
    {//공격 끝났을 경우
        base.ShootDone();
